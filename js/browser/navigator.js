...
function displayOutput(output) {
	console.log("geolocationInfo", "<div>" + output + "</div>");
}
function errorMessage(msg)
{
	console.log("<span class='color:red'><b>Error</b>:" + msg + "</span>");
}
...
function getDuration(start) {
	...
	try {
		...
		console.log("Exception (getDuration): " + e);
	}
	return duration;
}
...
function distanceBetweenPoints(current_lat, current_lon, target_lat, target_lon) {
	...
	try {
		...
		console.log("exception (distanceBetweenPoints): " + e);
	}
	return distance;
}
...
function displayLocationInfo(time, coordinates) {
	try {
		...
		console.log("exception (displayLocationInfo): " + e);
	}
}
